...
if (isset($_POST['update_equipment'])) {
  $req_fields = array('equipment-tombo', 'equipment-specifications', 'equipment-type_equip', 'equipment-manufacturer', 'equipment-situation', 'equipment-IMEI');
  ...
  if (empty($errors)) {
    ...
    $query  .= " obs ='{$equip_obs}',";
    if (empty($equip_warranty)) $query  .= " warranty = NULL,";
    else $query  .= " warranty ='{$equip_warranty}',";
      ...
      <div class="col-md-12">
        <form method="post" action="editar_equipamento.php?id=<?= (int)$equipment['id'] ?>" class="clearfix">
          ...
          <div class="input-group">
            ...
            <input type="text" class="form-control" name="equipment-IMEI" placeholder="Número do IMEI" value="<?= (int)$equipment['IMEI'] ?>" readonly>
          </div>
