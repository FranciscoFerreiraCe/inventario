...
if(isset($_POST['add_equipment'])){
	...
	if(empty($errors)){
		...
		$equip_imei  = remove_junk($db->escape($_POST['equipment-imei']));
		...
		$query .=" tombo,imei_number, specifications, obs, types_equip_id, manufacturer_id, situation_id, warranty, created_by, created_at";
		$query .=") VALUES (";		
		$query .=" '{$equip_tombo}','{$equip_imei}', '{$equip_specifications}', '{$equip_obs}', '{$equip_type_equip}', '{$equip_manufacturer}', '{$equip_situation}',";
							...
							<div class="row">              
								<div class="col-md-12">
									...
									<div class="input-group">
										...
										<input type="number" class="form-control" name="equipment-imei" placeholder="Número IMEI" required autocomplete="off">
									</div>
								</div>
							</div> 
						</div>			 
